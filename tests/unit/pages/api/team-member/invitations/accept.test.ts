...
import { POST } from '../../../../../../src/pages/api/team-member/invitations/accept';
vi.mock('../../../../../../src/actions/accept-invitation-team-member');
vi.mock('@/lib/api/api-guard');

describe('TeamMember API - POST ../../../../../../src/pages/api/team-member/invitations/accept', () => {
  beforeEach(() => {
    vi.resetAllMocks();
    vi.mocked(ApiGuard.protect).mockResolvedValue(undefined);
  });

  it('should call AcceptInvitationTeamMemberAction and return success', async () => {
    ...
    vi.mocked(AcceptInvitationTeamMemberAction.run).mockResolvedValue({
      success: true,
      data: { id: 'test-id' },
