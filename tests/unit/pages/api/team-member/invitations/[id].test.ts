...
import { DELETE } from '../../../../../../src/pages/api/team-member/invitations/[id]';
vi.mock('../../../../../../src/actions/delete-invitation-team-member');
vi.mock('@/lib/api/api-guard');

describe('TeamMember API - DELETE ../../../../../../src/pages/api/team-member/invitations/[id]', () => {
  beforeEach(() => {
    vi.resetAllMocks();
