...
import { TeamAuthService } from '../../../src/services/team-auth-service';
...
vi.mock('@/lib/core/db', () => {
  ...
  (globalThis as unknown as Record<string, () => void>)._resetTeamAuthServiceMocks =
    resetImplementations;
  return {
...
describe('TeamAuthService', () => {
  beforeEach(() => {
    ...
    if (globalAny._resetTeamAuthServiceMocks) {
      globalAny._resetTeamAuthServiceMocks();
    }
