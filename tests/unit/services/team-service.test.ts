...
vi.mock('@/lib/core/db', () => {
  const mockModelProps = { id: 'team_test', name: 'test' };
...
describe('TeamService', () => {
  ...
  describe('list', () => {
    it('should return a list of Teams', async () => {
      ...
      const result = await TeamService.list(
        { id: 'team_test', name: 'test' } as Record<string, unknown>,
        'team_test' as unknown,
      );
  ...
  describe('get', () => {
    it('should return a single Team', async () => {
      ...
      const result = await TeamService.get('1', 'team_test' as unknown, 'team_test' as unknown);
  ...
  describe('create', () => {
    it('should create a new Team', async () => {
      ...
      const result = await TeamService.create({ id: 'team_test', name: 'test' } as Record<
        string,
        unknown
      >);
  ...
  describe('update', () => {
    it('should update an existing Team', async () => {
      ...
      const result = await TeamService.update('1', { id: 'team_test', name: 'test' } as Record<
        string,
        unknown
      >);
